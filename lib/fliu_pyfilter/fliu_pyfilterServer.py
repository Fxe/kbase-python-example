...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'fliu_pyfilter'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from fliu_pyfilter.fliu_pyfilterImpl import fliu_pyfilter  # noqa @IgnorePep8
impl_fliu_pyfilter = fliu_pyfilter(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'fliu_pyfilter'
        ...
        self.rpc_service.add(impl_fliu_pyfilter.run_fliu_pyfilter,
