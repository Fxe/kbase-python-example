...
/**
 * <p>Original spec-file module name: fliu_pyfilter</p>
 * <pre>
 * A KBase module: fliu_pyfilter
 * This sample module contains one small method - filter_contigs.
 * </pre>
 */
public class FliuPyfilterClient {
     ...
     */
    public FliuPyfilterClient(URL url) {
     ...
     * validity.
     */
    public FliuPyfilterClient(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public FliuPyfilterClient(URL url, String user, String password) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public FliuPyfilterClient(URL url, String user, String password, URL auth) throws UnauthorizedException, IOException {
    ...
    public FilterContigsResults filterContigs(FilterContigsParams params, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<FilterContigsResults> res = caller.jsonrpcCall("fliu_pyfilter.filter_contigs", args, retType, true, true, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
    ...
    public FilterContigsResults filterContigsChanged(FilterContigsParams params, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        args.add(params);
        TypeReference<List<FilterContigsResults>> retType = new TypeReference<List<FilterContigsResults>>() {};
        List<FilterContigsResults> res = caller.jsonrpcCall("fliu_pyfilter.filter_contigs_changed", args, retType, true, true, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
    ...
    public Map<String, Object> status(RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<Map<String, Object>> res = caller.jsonrpcCall("fliu_pyfilter.status", args, retType, true, false, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
}
